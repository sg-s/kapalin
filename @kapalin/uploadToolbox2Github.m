...
% create a release 
[e,o]=system(['github-release release --user ' options.github_user_name ' --repo ' options.github_repo ' --tag ' datestr(today) ' --name ' datestr(today) ' -s ' github_token ' --description ' desc]);
